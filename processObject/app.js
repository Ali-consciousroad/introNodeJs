// Store the starting amount of memory
let initialMemory = process.memoryUsage().heapUsed;
// This will print the 3 words written after launching the app ex: node app.js test (Your word is test will be displayed).
